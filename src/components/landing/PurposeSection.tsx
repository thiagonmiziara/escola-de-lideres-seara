  ...
  const purposes = [
    {
      ...
      description:
        'Descubra o chamado de Deus para sua vida e aprenda a viver com intencionalidade em cada área.',
    },
    {
      icon: BookOpen,
      title: 'Fundamento Bíblico',
      description:
        'Ensinamentos sólidos baseados na Palavra de Deus para aplicação prática no dia a dia.',
    },
    {
      icon: Users,
      title: 'Comunidade Forte',
      description:
        'Conecte-se com líderes que compartilham os mesmos valores e objetivos de crescimento.',
    },
    {
      icon: Sparkles,
      title: 'Transformação Real',
      description:
        'Experimente mudanças duradouras através de princípios e ferramentas comprovadas.',
    },
  ];
      ...
      <div className='container px-4 md:px-6 relative z-10'>
        ...
        >
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            A Escola de Líderes não é apenas mais um curso. É um{' '}
            <strong>movimento de transformação</strong> que capacita pessoas
            comuns a viverem vidas extraordinárias, alinhadas ao propósito de
            Deus.
          </p>
        </motion.div>
        ...
        >
          <blockquote className='text-2xl md:text-3xl font-serif italic mb-6'>
            A primeira pessoa que você lidera é a si próprio.
          </blockquote>
